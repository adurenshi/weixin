...
<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
    ...
    <ul>
    <li><a href="users.php" data-target=".dashboard-menu" class="nav-header" data-toggle="collapse"><i class="fa-fw glyphicon glyphicon-record"></i> &nbsp;员工管理<i class="far glyphicon glyphicon-menu-right"></i></a></li>
